...
using Xunit;
using System;
using SeleniumGeneratedClasses.Framework.RPS.Services.Quality.Customer ;
namespace UnitTest.Framework.RPS.Services.Quality
{
    public class Customer_New
    {
        ...
        public void New_UT()
        {
            ...
            using (var screen = new SeleniumGeneratedClasses.Framework.RPS.Services.Quality.Customer.Customer())
            {
