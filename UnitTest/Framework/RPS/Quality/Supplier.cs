...
using Xunit;
using System;
using SeleniumGeneratedClasses.Framework.RPS.Services.Quality.Supplier ;
namespace UnitTest.Framework.RPS.Services.Quality
{
    public class Supplier_New
    {
        ...
        public void New_UT()
        {
            ...
            using (var screen = new SeleniumGeneratedClasses.Framework.RPS.Services.Quality.Supplier.Supplier())
            {
