...
using Xunit;
using System;
using SeleniumGeneratedClasses.Framework.RPS.Services.Project.Supplier ;
namespace UnitTest.Framework.RPS.Services.Project
{
    public class Supplier_New
    {
        ...
        public void New_UT()
        {
            ...
            using (var screen = new SeleniumGeneratedClasses.Framework.RPS.Services.Project.Supplier.Supplier())
            {
