...
using Xunit;
using System;
using SeleniumGeneratedClasses.Framework.RPS.Services.Project.Customer ;
namespace UnitTest.Framework.RPS.Services.Project
{
    public class Customer_New
    {
        ...
        public void New_UT()
        {
            ...
            using (var screen = new SeleniumGeneratedClasses.Framework.RPS.Services.Project.Customer.Customer())
            {
